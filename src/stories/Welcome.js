  ...
  render() {
    return (
      <div style={styles.main}>
        ...
        <p>
          See these sample <a style={styles.link} href='#' onClick={this.showApp.bind(this)}>stories</a> for a component
          called <code style={styles.code}>Button</code>.
        </p>
        <p>
        ...
        <p>
          ...
          Have a look at the <a style={styles.link} href='https://getstorybook.io/docs/basics/writing-stories'
